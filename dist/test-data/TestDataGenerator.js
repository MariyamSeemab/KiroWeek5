...
class TestDataGenerator {
    ...
    generateTestSymbols() {
        return [
            ...
            {
                shape: 'Triangle',
                destinationType: models_1.DestinationType.RESIDENTIAL_CHAWL,
    ...
    generateTestColors() {
        return [
            {
                color: 'Red',
                priority: models_1.PriorityLevel.URGENT,
            ...
            {
                color: 'Orange',
                priority: models_1.PriorityLevel.HIGH,
            ...
            {
                color: 'Yellow',
                priority: models_1.PriorityLevel.MEDIUM,
    ...
    generateMumbaiTerminologyTests() {
        return [
            {
    ...
    generateMarkerStringVariations() {
        const baseMarker = {
            color: 'Red',
            symbol: 'Triangle',
            stationCode: 'VLP',
    ...
    generateStationSimilarityTests() {
        return [
    ...
    generateTestProtocolFileContent() {
...
`;
    ...
    generateReliabilityTestScenarios() {
        return [
            {
    ...
    generateThresholdBoundaryTests() {
        return [
            {
