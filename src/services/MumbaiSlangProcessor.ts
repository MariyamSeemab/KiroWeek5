...
export class MumbaiSlangProcessor {
  private protocolKB: ProtocolKnowledgeBase;
  private slangCache: Map<string, SlangMapping> = new Map();
  private abbreviationCache: Map<string, string> = new Map();
  ...
  private buildAbbreviationCache(): void {
  ...
  processInput(input: string): {
    ...
    expansions: string[];
    abbreviationExpansions: { [key: string]: string };
  } {
  ...
  private generateExpansion(slang: SlangMapping): string | null {
